...
class UIButton(UIElement):
    def __init__(
        ...
        label="",
        interactable=True,
        highlight_color=(134, 134, 134, 255),
        selected_color=(255, 255, 255, 255),
        disabled_color=(255, 0, 0, 255),
        text_button=False,
    ):
    ...
    def does_collide(self, to_check) -> bool:
        return (
            to_check[0] > self.pos[0]
            and to_check[1] > self.pos[1]
            and to_check[0] < self.pos[0] + self.width_height[0]
            and to_check[1] < self.pos[1] + self.width_height[1]
        )
